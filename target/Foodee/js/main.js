...
function initMap() {
	...
	if (d.getHours()<11) 
	var uluru = {lat: 26.867664, lng: 81.0063273};
	else if (d.getHours()<13) 
	var uluru = {lat: 26.867664, lng: 80.9910065};
	else if (d.getHours()<15) 
	var uluru = {lat: 26.8517372, lng:80.9393365};
	else  var uluru = {lat: 26.8293818, lng: 80.9108793};
